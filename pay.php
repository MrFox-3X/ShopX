...
/* End Footer Section */
        ...
        .payment-container {
            text-align: center;
            max-width: 400px;
            margin: 50px auto 0 auto; /* Added margin-top: 20px */
            background: white;
            padding: 20px;
            border-radius: 5px;
...
.mod {
        ...
        .btn:hover {
            background-color: rgb(230, 160, 20);
        }
.modal {
    display: none;
    position: fixed;
...
<body id="top">
  ...
  <header class="header" data-header>
    ...
    <div class="payment-container">
        <h2>Pay with USDT</h2>
        <p>Send your payment to the address below:</p>
        <div class="wallet-address">TQJxZsX9yxyp1Xw2F2VkQm5p6GJ6Z2UoWp</div>
        <center><img src="https://api.qrserver.com/v1/create-qr-code/?size=200x200&data=TQJxZsX9yxyp1Xw2F2VkQm5p6GJ6Z2UoWp"
            alt="USDT QR Code" class="qr-code"></center>
        <p>Enter the Transaction ID after making the payment:</p>
        <input type="text" id="transaction-id" placeholder="Enter Transaction ID" required>
        <button class="btn" onclick="showSuccessModal()">Submit Payment</button>
    </div>

    <div class="overlay" id="overlay"></div>
    <div class="modal" id="success-modal">
      <div class="contain" id="successMessage">
        <div class="checkmark"></div>
        <div class="message"><h1>Payment received.<br></h1>Thank you for your purchase! Your order will be shipped within 3 business days. You’ll receive an email with tracking details once it’s on its way.

Thanks again for shopping with us!</div>
    </div>
    ...
    <script>
        ...
        <button class="mod" onclick="closeModal()">OK</button>
    </div>
