          ...
          <div class="deal-item">
           ...
           <div class="deal-items-list">
            <div class="deal-items-info">
              ...
              <a href="<?php echo (isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] === 'on' ? 'https' : 'http') . '://' . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI']; ?>" class="deal-btn">Buy Now <i class="fa-solid fa-chevron-right"></i></a>
            </div>
            <div class="deal-items-img">
